...
openPic.ShowDialog() 
End Sub 
Private Sub openPic_FileOk(ByVal sender As System.Object, ByVal e As 
System.ComponentModel.CancelEventArgs) Handles openPic.FileOk 
...
Ready = False 
MsgBox("Please load a picture before clicking this button", 
...
Dim SentinelString() As Byte = {73, 116, 83, 116, 97, 114, 116, 115, 72, 101, 
114, 101} 
...
Next 
Dim PicAndText(PicBytes + PlainText.Length + SentinelString.Length) As 
Byte 
...
Next 
count = 0 
For q As Long = (PicBytes + SentinelString.Length) To (PicBytes + 
...
End If 
End Sub 
Sub ResizeFileName(ByVal LongFileName As String, ByVal ShortFileName 
As String) 
...
End Sub 
Function EncryptDecrypt(ByVal text1 As String, ByVal key As String, ByVal 
isEncrypt As Boolean) As String 
Dim char1 As String 
Dim char2 As String 
Dim cKey As Byte 
...
Return Result 
End Function 
Private Sub btCrypt_Click_1(ByVal sender As System.Object, ByVal e As 
System.EventArgs) Handles btCrypt.Click 
Me.txtText.Text = EncryptDecrypt(Me.TextBox3.Text, txtKey.Text, False) 
End Sub 
